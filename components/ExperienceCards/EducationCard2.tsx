    ...
    return (
        ...
        opacity-40 cursor-pointer transition-opacity duration-200 overflow-hidden'>
            <motion.img
                ...
                src='https://toolkit.baruch.cuny.edu/wp-content/uploads/sites/11/2020/03/Baruch-College-stacked-Logo.jpg'
            />
            <div className='px-0 md:px-10'>
                ...
                <ul className='list-disc space-y-4 ml-5 text-lg'>
                    <ul>Grade: 3.5/4.0</ul>
                    <ul>Coursework: Corporate Finance, Investment Analysis, Real Estate Capital Market, Real Estate Law
Other Coursework: Calculus I, II, III and Linear Algebra</ul>
                </ul>
